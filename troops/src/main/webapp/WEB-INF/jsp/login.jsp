...
<body>
	...
	<!-- Styled Button (形状) -->
	<div id="u2" class="ax_形状" data-label="Styled Button">
		<img id="u2_img" class="img " src="images/登录/styled_button_u2.png" />
		<!-- Unnamed () -->
		<div id="u3" class="text">
			<p>
				<span>登</span><span>&nbsp;&nbsp; </span><span>&nbsp; </span><span>录</span>
			</p>
		</div>
	</div>

	<!-- Styled Button (形状) -->
	<div id="u4" class="ax_形状" data-label="Styled Button">
		<img id="u4_img" class="img " src="images/登录/styled_button_u2.png" />
		<!-- Unnamed () -->
		<div id="u5" class="text">
			<p>
				<span>取&nbsp;&nbsp; </span><span>&nbsp;</span><span>消</span>
			</p>
		</div>
	</div>

	<!-- textfield (文本框(单行)) -->
	<div id="u6" class="ax_文本框_单行_">
		<input id="u6_input" type="text" value="hanlu" data-label="textfield" />
	</div>

	<!-- textfield (文本框(单行)) -->
	<div id="u7" class="ax_文本框_单行_">
		<input id="u7_input" type="password" value="123456"
